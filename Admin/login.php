...
<body>
<nav class="navbar navbar-expand-lg navbar-light" style="margin:40px;text-decoration: none;">
...
<div class="container" style="width: 55%; align-items: center; justify-content: center;">
  <div class="row">
    ...
    <form id="myform" class="login-form" method ="post" action="" style="width: 100%;" >
          ...
          <label class="float-left form-check-label"><input type="checkbox"> Remember me</label>   
           ...
           <!--Login btn-->
            <div class="form-group">
                ...
                <a href="dashboard.php" class="btn btn-danger" style="width: 100%;">Login</a>
                </div>
